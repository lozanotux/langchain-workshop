...
RAG_TEMPLATE = """Eres un asistente legal especializado en contratos de alquiler.
...
MULTI_QUERY_PROMPT = """Eres un experto en análisis de documentos legales especializados en contratos de alquiler.
...
- Sinónimos legales y términos técnicos de alquiler
...
ENTITY_EXTRACTION_PROMPT = """Extrae las entidades clave del siguiente texto de contrato de alquiler:

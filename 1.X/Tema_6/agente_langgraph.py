...
# from langgraph.prebuilt import create_react_agent  # obsoleto, se mueve al siguiente import
        ...
        response = agent_executor.invoke(
            {
                "messages": [
                    (
                        "human",
                        "Procesa el email mas reciente en la bandeja de entrada y genera un borrador de respuesta profesional",
                    )
                ]
            },
            config=config,

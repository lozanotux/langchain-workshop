...
class VectorRAGSystem:
    ...
    def __init__(self, chroma_path: str = "chroma_db"):
        ...
        self.llm = ChatMistralAI(model=LLM_MODEL, temperature=0)
    ...
    def _load_vectorstore(self):
        ...
        try:
            ...
            self.retriever = MultiQueryRetriever.from_llm(
                ...
                llm=self.llm,
                prompt=ChatPromptTemplate.from_template(MULTIQUERY_PROMPT),
            )
    ...
    def _generar_respuesta(self, consulta: str, contexto: str) -> str:
        ...
        prompt = ChatPromptTemplate.from_template(GENERAR_RESPUESTA_PROMPT)
